  ...
  return (
    <div className="w-full overflow-hidden pb-20">
      <div className="mb-4 grid grid-cols-1 gap-4 lg:grid-cols-4">
        {/* Header Card */}
        <div className="group relative flex flex-col overflow-hidden rounded-[1.5rem] border border-zinc-200 bg-white/50 p-8 backdrop-blur-xl lg:col-span-4 lg:p-10 dark:border-zinc-800/80 dark:bg-zinc-900/50">
          ...
          <div className="relative z-10 mb-8 flex w-full flex-col gap-6 pt-2 md:flex-row md:items-start md:justify-between">
            <div className="flex-1">
              <div className="mb-6 inline-flex items-center gap-2 rounded-lg border border-zinc-200 bg-zinc-100 px-3 py-1.5 text-[10px] font-bold tracking-wider text-zinc-600 uppercase shadow-sm backdrop-blur-sm transition-colors dark:border-zinc-700/50 dark:bg-zinc-800/80 dark:text-zinc-300">
                <Users size={12} className="text-[#eab308]" /> Professional Network
              </div>
              ...
              <h2 className="mb-4 max-w-2xl text-3xl leading-[1.1] font-bold tracking-tight text-zinc-900 sm:text-4xl lg:text-5xl dark:text-zinc-100">
                Global <span className="font-medium text-[#eab308] italic">Connections</span>
              </h2>
        ...
        <div className="vbiz-bento-grid relative z-20 mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {cards.map((card, idx) => (
            <motion.div
              ...
              key={card.id}
              className="group relative flex cursor-pointer flex-col overflow-hidden rounded-[1.5rem] border border-white/5 bg-zinc-950/30 shadow-sm backdrop-blur-3xl transition-colors duration-300 hover:bg-zinc-950/40"
            >
              ...
              {cards.map((card, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="transform-style-3d group/card absolute w-[260px] cursor-pointer overflow-hidden rounded-[1.5rem] border border-zinc-800/80 bg-zinc-900 shadow-sm transition-colors duration-300 md:w-[300px]"
                    style={{ height: '420px' }}
                  >
                    ...
                    <div className="relative h-[260px] w-full overflow-hidden bg-zinc-950">
                      ...
                      >
                        <div
                          className="absolute -top-[5%] -left-[5%] h-[110%] w-[110%] translate-x-[var(--mouse-x,0px)] translate-y-[var(--mouse-y,0px)] bg-cover bg-center grayscale-[20%] transition-transform duration-300 ease-out group-hover/card:scale-105"
                    ...
                    <div className="relative z-20 -mt-4 flex h-[160px] flex-col items-center justify-between border-t border-zinc-800/80 bg-zinc-900 p-6">
                      <div className="w-full text-center">
                        ...
                        <p
                          className="mt-1.5 w-full truncate px-2 text-[10px] font-bold tracking-wider text-[#eab308] uppercase md:text-xs"
