...
const ContactDetailItem: React.FC<{ item: ContactDetailItemData }> = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      <div className="mr-3 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-zinc-100 text-zinc-900 dark:bg-zinc-800 dark:text-zinc-100">
        <item.icon size={18} />
      </div>
      ...
      <div className="min-w-0 flex-1">
        ...
        {item.isLink ? (
          ...
          <span className="block truncate text-sm font-semibold text-zinc-900 dark:text-zinc-100">{item.value}</span>
        )}
      </div>
...
export const HomeSectionV2 = () => {
  ...
  return (
    <div className="vbiz-bento-grid grid w-full grid-cols-1 gap-4 pb-20 md:grid-cols-3 lg:grid-cols-4">
      ...
      <div className="group relative flex min-h-[360px] flex-col justify-between overflow-hidden rounded-3xl border border-zinc-200 bg-white p-8 md:col-span-3 lg:col-span-3 lg:p-10 dark:border-zinc-800/80 dark:bg-zinc-900">
        {/* Background Video */}
        ...
        <div className="relative z-10 mt-auto flex w-full flex-wrap items-center gap-4">
          <button className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-zinc-900 px-8 py-4 text-sm font-bold text-white shadow-lg transition-all hover:bg-zinc-800 hover:shadow-[0_0_20px_rgba(0,0,0,0.1)] active:scale-95 sm:flex-none dark:bg-zinc-100 dark:text-zinc-950 dark:hover:bg-white dark:hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]">
      ...
      <div className="group relative flex flex-col items-center justify-center overflow-hidden rounded-3xl bg-linear-to-br from-[#eab308] to-[#ca8a04] p-6 text-center text-[#09090b] transition-all duration-500 hover:shadow-[0_20px_40px_-15px_rgba(234,179,8,0.3)] md:col-span-3 lg:col-span-1 lg:p-8">
      ...
      <div className="group relative flex min-h-[220px] items-center overflow-hidden rounded-3xl border border-zinc-200 bg-white/50 backdrop-blur-xl transition-all duration-500 hover:border-zinc-300 md:col-span-1 lg:col-span-1 dark:border-zinc-800/80 dark:bg-zinc-900/50 dark:hover:border-zinc-700">
        ...
        />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-white via-white/60 to-transparent dark:from-zinc-950 dark:via-zinc-900/60" />
        ...
        <div className="relative z-10 flex h-full w-full flex-col justify-end p-6">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              <h3 className="mb-1 text-lg leading-tight font-bold text-zinc-900 dark:text-zinc-100">
                Connecticut
                <br />
                USA
              </h3>
          ...
          {[
            {
              icon: Linkedin,
              brand:
                'hover:bg-[#0a66c2] hover:border-[#0a66c2]/50 hover:shadow-[0_0_15px_rgba(10,102,194,0.4)] hover:text-white',
            },
            {
              icon: Twitter,
              brand:
                'hover:bg-[#1da1f2] hover:border-[#1da1f2]/50 hover:shadow-[0_0_15px_rgba(29,161,242,0.4)] hover:text-white',
            },
            {
              icon: Instagram,
              brand:
                'hover:bg-[#e1306c] hover:border-[#e1306c]/50 hover:shadow-[0_0_15px_rgba(225,48,108,0.4)] hover:text-white',
            },
            {
              icon: Globe,
              brand:
                'dark:hover:bg-zinc-100 hover:bg-zinc-900 dark:hover:text-zinc-950 hover:text-zinc-100 hover:shadow-[0_0_15px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_0_15px_rgba(255,255,255,0.2)]',
            },
          ].map((item, idx) => (
            <a
              key={idx}
              href="#"
              className={`flex aspect-square w-full items-center justify-center rounded-xl border border-zinc-200 bg-zinc-100/50 text-zinc-600 backdrop-blur-sm transition-all duration-300 hover:text-zinc-900 active:scale-95 dark:border-zinc-700 dark:bg-zinc-800/50 dark:text-zinc-400 dark:hover:text-white ${item.brand}`}
            >
